...
func main() {
	...
	ledgerCreds, err := sharedGRPC.GetClientDialCredentials(cfg.IsProduction(), cfg.GRPCSSLCertPath, cfg.GRPCSSLKeyPath, cfg.GRPCSSLCAPath, "ledger-service")
	if err != nil {
	...
	serverOpts = append(serverOpts, grpc.UnaryInterceptor(sharedGRPC.RequireServiceIdentity(!cfg.IsProduction(), "api-gateway", "payment-service", "scheduler-service")))
